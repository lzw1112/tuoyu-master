...
update_tof_data();
            ...
            if((ros::Time::now() - begin_time_laser) < ros::Duration(2))
            {
            ...
            if((ros::Time::now() - begin_time_laser2) < ros::Duration(2))
            {
            ...
            if((ros::Time::now() - begin_time_camera) < ros::Duration(2))
            {
            ...
            else
            {
             ...
             if((ros::Time::now() - begin_time_rgb) < ros::Duration(2))
            {
            ...
            if((ros::Time::now() - begin_time_gnss) < ros::Duration(2))
            {
            ...
            if((ros::Time::now() - begin_time_imu) <  ros::Duration(2))
            {

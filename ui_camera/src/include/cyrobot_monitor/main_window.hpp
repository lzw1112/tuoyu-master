...
private:
    ...
    SwitchButton *button_switch_ROI;
    SwitchButton *button_switch_detection;
    SwitchButton *button_switch_canny;
    SwitchButton *button_switch_hough;
...
//    void on_horizontalSlider_raw_valueChanged(int value);
    ...
    void slot_startUp_ROI(bool checked);
    void slot_startUp_canny(bool checked);
    void slot_startUp_hough(bool checked);
    void slot_startUp_detection(bool checked);

    void slot_setup_canny_arg(bool checked);
    void slot_setup_ROI_arg(bool checked);
    void slot_setup_detection_arg(bool checked);
    void slot_setup_hough_arg(bool checked);

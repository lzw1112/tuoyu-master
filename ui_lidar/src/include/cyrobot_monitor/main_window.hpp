...
private:
    ...
    SwitchButton *button_switch_downsample;
    SwitchButton *button_switch_ground;
    SwitchButton *button_switch_detect;
...
//    void on_horizontalSlider_raw_valueChanged(int value);
    ...
    // lidat function switch
    void slot_startUp_downsample(bool checked);
    void slot_startUp_ground(bool checked);
    void slot_startUp_detect(bool checked);
